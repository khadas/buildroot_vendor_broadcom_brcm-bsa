...
#define BTA_SYNC_SERVICE_ID     9           /* Synchronization */
#define BTA_BPP_SERVICE_ID      10          /* Basic printing profile */
#define BTA_BIP_SERVICE_ID      11          /* Basic Imaging profile */
#define BTA_PANU_SERVICE_ID     12          /* PAN User */
#define BTA_NAP_SERVICE_ID      13          /* PAN Network access point */
#define BTA_GN_SERVICE_ID       14          /* PAN Group Ad-hoc networks */
#define BTA_SAP_SERVICE_ID      15          /* SIM Access profile */
#define BTA_A2DP_SERVICE_ID     16          /* Advanced audio distribution */
#define BTA_AVRCP_SERVICE_ID    17          /* A/V remote control */
#define BTA_HID_SERVICE_ID      18          /* HID */
#define BTA_VDP_SERVICE_ID      19          /* Video distribution */
#define BTA_PBAP_SERVICE_ID     20          /* PhoneBook Access Server*/
#define BTA_HSP_HS_SERVICE_ID   21          /* HFP HS role */
#define BTA_HFP_HS_SERVICE_ID   22          /* HSP HS role */
#define BTA_MAP_SERVICE_ID      23          /* Message Access Profile */
#define BTA_MN_SERVICE_ID       24          /* Message Notification Service */
#define BTA_HDP_SERVICE_ID      25          /* Health Device Profile */
#define BTA_PCE_SERVICE_ID      26          /* PhoneBook Access Client*/
#define BTA_3DS_SERVICE_ID      27          /* 3D Sync Client */
#define BTA_CAS_SERVICE_ID      28          /* CTN Access Service */
#define BTA_CNS_SERVICE_ID      29          /* CTN Notification Service */
...
#define BTA_SYNC_SERVICE_MASK       0x00000200  /* Synchronization */
#define BTA_BPP_SERVICE_MASK        0x00000400  /* Print server */
#define BTA_BIP_SERVICE_MASK        0x00000800  /* Basic Imaging */
#define BTA_PANU_SERVICE_MASK       0x00001000  /* PAN User */
#define BTA_NAP_SERVICE_MASK        0x00002000  /* PAN Network access point */
#define BTA_GN_SERVICE_MASK         0x00004000  /* PAN Group Ad-hoc networks */
#define BTA_SAP_SERVICE_MASK        0x00008000  /* SIM Access Profile */
#define BTA_A2DP_SERVICE_MASK       0x00010000  /* Advanced audio distribution */
#define BTA_AVRCP_SERVICE_MASK      0x00020000  /* A/V remote control */
#define BTA_HID_SERVICE_MASK        0x00040000  /* HID */
#define BTA_VDP_SERVICE_MASK        0x00080000  /* Video distribution */
#define BTA_PBAP_SERVICE_MASK       0x00100000  /* Phone Book Server */
#define BTA_HSP_HS_SERVICE_MASK     0x00200000  /* HFP HS role */
#define BTA_HFP_HS_SERVICE_MASK     0x00400000  /* HSP HS role */
#define BTA_MAS_SERVICE_MASK        0x00800000  /* Message Access Profile */
#define BTA_MN_SERVICE_MASK         0x01000000  /* Message Notification Profile */
#define BTA_HL_SERVICE_MASK         0x02000000  /* Health Device Profile */
#define BTA_PCE_SERVICE_MASK        0x04000000  /* Phone Book Client */
#define BTA_3DS_SERVICE_MASK        0x08000000  /* 3D Sync service */
#define BTA_CAS_SERVICE_MASK        0x10000000  /* CTN access service */
#define BTA_CNS_SERVICE_MASK        0x20000000  /* CTN notification service */
...
/* Structure associated with BTA_DM_SP_KEY_REQ_EVT */
typedef struct
{
    /* Note: First 3 data members must be, bd_addr, dev_class, and bd_name in order */
    BD_ADDR         bd_addr;        /* peer address */
...
typedef union
{
    ...
    tBTA_DM_SP_KEY_REQ  key_req;        /* passkey entry request */
...
#define BTA_DM_DI_DISC_CMPL_EVT         5       /* DI discovery complete. */
#define BTA_DM_SEARCH_CANCEL_CMPL_EVT   6       /* Search cancelled */
#define BTA_DM_MPS_SET_RECORD_CMPL_EVT  7       /* MPS set record complete */
#define BTA_DM_MPS_DISC_CMPL_EVT        8       /* MPS discovery complete */
#define BTA_DM_READ_REM_NAME_CMPL_EVT   9       /* Read Remote Device Name complete. */ /* BSA_SPECIFIC */
...
/**** MPS Constants and Structures ***/
#define BTA_MPS_MPSD_MASK_LEN           8
typedef UINT64 tBTA_MPS_MPSD_MASK;      /* MPSD Mask */

#define BTA_MPS_MPMD_MASK_LEN           8
typedef UINT64 tBTA_MPS_MPMD_MASK;      /* MPSD Mask */

#define BTA_MPS_PPD_MASK_LEN            2
typedef UINT16 tBTA_MPS_PPD_MASK;       /* MPSD Mask */

/* Structure associated with BTA_DmSetMpsRecord */
typedef struct
{
    tBTA_MPS_MPSD_MASK  mpsd_mask;       /* MP Single-Device Feature Mask (64-bit) */
    tBTA_MPS_MPMD_MASK  mpmd_mask;       /* MP Multi-Device Featurs Mask  (64-bit) */
    tBTA_MPS_PPD_MASK   ppd_mask;        /* Profile and Protocol Dependencies Mask */
} tBTA_DM_MPS_PARAMS;


/* Structure associated with BTA_DmMpsDiscover */
typedef struct
{
    tBTA_MPS_MPMD_MASK mpmd_mask;       /* MP Multi-Device Featurs Mask  (64-bit) */
    tBTA_MPS_MPSD_MASK mpsd_mask;       /* MP Single-Device Feature Mask (64-bit) */
    tBTA_MPS_PPD_MASK  ppd_mask;        /* Profile and Protocol Dependencies Mask */
    UINT16             profile_version; /* MPS Spec Version */
    tBTA_STATUS        result;          /* Result of operation */
} tBTA_DM_MPS_DISC_RESULT;
...
#if (defined(BTA_MPS_INCLUDED) && BTA_MPS_INCLUDED == TRUE)
    tBTA_DM_MPS_DISC_RESULT mps_res;    /* MPS discovery result */
    tBTA_STATUS             mps_sdp_res;    /* Result of SDP create/delete API */
#endif
} tBTA_DM_SEARCH;
...
**
*******************************************************************************/
BTA_API extern void BTA_DmSignalStrength(tBTA_SIG_STRENGTH_MASK mask, UINT16 period,
                                        BOOLEAN start);
...
**
*******************************************************************************/
BTA_API extern tBTA_STATUS BTA_DmGetDiRecord( UINT8 get_record_index,
                                            tBTA_DI_GET_RECORD *p_device_info,
...
**
*******************************************************************************/
BTA_API extern void BTA_DmBleConfirmReply(BD_ADDR bd_addr, BOOLEAN accept);
...
**
** Returns          BTA_SUCCESS if successful
**                  BTA_FAIL if operation failed, or if BLE not compiled in.
**
*******************************************************************************/
...
/*******************************************************************************
**
** Function         BTA_DmBleSetDataChannelPDULength
**
** Description      This function is to set maximum LL transmission packet size
**
** Returns          void
**
*******************************************************************************/
BTA_API extern void BTA_DmBleSetDataChannelPDULength (BD_ADDR remote_device, UINT16 tx_data_length);
...
**
*******************************************************************************/
BTA_API extern void BTA_DmPasskeyReqReply(tBTM_STATUS res, BD_ADDR bd_addr, UINT32 passkey);

#if (defined(BTA_MPS_INCLUDED) && BTA_MPS_INCLUDED == TRUE)
/*******************************************************************************
**
** Function         BTA_DmSetMpsRecord
**
** Description      This function adds an MPS record to the local SDP database.
**
** Parameters       expose_record - (BOOLEAN) TRUE to show in SDP, False to delete
**                  p_parms - ptr to scenario masks. Can be NULL if expose_record=FALSE
**
** Returns          void
**
**                  BTA_DM_MPS_SET_RECORD_CMPL_EVT with status is returned
**
*******************************************************************************/
BTA_API extern void BTA_DmSetMpsRecord (BOOLEAN expose_record,
                                        const tBTA_DM_MPS_PARAMS *p_params,
                                        tBTA_DM_SEARCH_CBACK *p_cback);

/*******************************************************************************
**
** Function         BTA_DmMpsDiscover
**
** Description      This function queries a remote device for MPS scenarios
**                  supported.
**
** Returns          void
**
**                  BTA_DM_MPS_DISC_CMPL_EVT with status and peer's supported masks
**                  (tBTA_DM_MPS_DISC_RESULT)
**
*******************************************************************************/
BTA_API extern void BTA_DmMpsDiscover(BD_ADDR remote_device, tBTA_DM_SEARCH_CBACK *p_cback);
