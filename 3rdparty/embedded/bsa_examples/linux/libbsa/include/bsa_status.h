...
#define BSA_ERROR_SRV_BUSY                  212 /* Another operation is ongoing */
...
#define BSA_ERROR_SRV_AVK_AV_REGISTERED           804    /* AV was registered before AVK, AV should be registered after AVK */
#define BSA_ERROR_SRV_AVK_REGISTERED              805    /* AVK was registered already */

/* Insert new AV errors here and don't forget to update the following line (offset) */
#define BSA_ERROR_SRV_AVK_OFFSET            BSA_ERROR_SRV_AVK_REGISTERED

#define BSA_ERROR_SRV_AVK_FAIL      (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL)           /* Generic failure */
#define BSA_ERROR_SRV_AVK_SDP       (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_SDP)       /* service not found (SDP) */
#define BSA_ERROR_SRV_AVK_STREAM    (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_STREAM)    /* stream connection failed */
#define BSA_ERROR_SRV_AVK_RESOURCES (BSA_ERROR_SRV_AVK_OFFSET + BTA_AVK_FAIL_RESOURCES) /* no resources */
