...
#define BTA_AV_FEAT_ACP_START   0x0800  /* autostart stream to the 2nk sink when source is the acceptor  */
#define BTA_AV_FEAT_INT_START   0x1000  /* autostart stream to the 2nk sink when source is the initiator */
...
#define BTA_AV_NUM_STRS         6   /* BSA_SPECIFIC Insight config over-rides this in BTE */
#endif

#ifndef BTA_AV_MAX_SEPS
#define BTA_AV_MAX_SEPS         6  /* BSA_SPECIFIC Insight config over-rides this in BTE */
#endif
