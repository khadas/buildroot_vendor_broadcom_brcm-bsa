...
#define BSA_SEC_AUTH_REQ_SETTING  BTM_AUTH_AP_YES
#endif
...
/* BLE encryption keys */
#define tBSA_LE_PENC_KEYS    tBTA_LE_PENC_KEYS
#define tBSA_LE_PCSRK_KEYS   tBTA_LE_PCSRK_KEYS
#define tBSA_LE_LENC_KEYS    tBTA_LE_LENC_KEYS
#define tBSA_LE_LCSRK_KEYS   tBTA_LE_LCSRK_KEYS
#define tBSA_LE_PID_KEYS     tBTA_LE_PID_KEYS
